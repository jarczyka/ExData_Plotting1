...
png(file = "plot4.png")
par(mfrow = c(2,2))
plot(dt[,"Global_active_power"] ~ dt[,"Time"], type="l", xlab="", ylab="Global Active Power")
plot(dt[,"Voltage"] ~ dt[,"Time"], type="l", xlab="datetime", ylab="Voltage")
...
plot(dt[,"Global_reactive_power"] ~ dt[,"Time"], type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()